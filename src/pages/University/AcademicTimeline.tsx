        ...
        <div className="space-y-8">
          {timelineEvents.map((event, index) => (
            <div key={event.id} className="group relative flex items-start">
              {/* Icon Container */}
              <div
                className={`relative z-10 flex h-16 w-16 items-center justify-center rounded-full ${event.iconBg} border-4 border-white shadow-lg transition-transform duration-300`}
              >
